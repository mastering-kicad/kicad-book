...
During annotation, this question mark is replaced by a sequential number\sidenote{The sequence of the number can optionally be set to start at the beginning of the hierarchy or at a multiple (10x, 100x) of the sheet number}, giving each component in your schematic a unique reference.

\begin{figure}
	\includegraphics{chapter11/60-Annotate.png}
