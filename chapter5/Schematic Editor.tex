...
\begin{figure*}
    ...
    \begin{scope}
        ...
        \begin{scope}[x={(image.south east)},y={(image.north west)}]
            ...
            \node [anchor=south] (zoom) at (0.438,1.0) {\Large Zoom\strut };
            \node [anchor=south] (app) at (0.763,1.0) {\Large Applications\strut };
            \node [anchor=north, rotate=90] (tools) at (1.0,0.5) {\Large Schematic Tools};
            
            \draw[help lines,xstep=.05,ystep=.05] (0,0) grid (1,1);
            \draw[red,thick,rounded corners] (0.0,0.923) rectangle (0.16,0.97);
            \draw[red,thick,rounded corners] (0.165,0.923) rectangle (0.35,0.97);
            \draw[red,thick,rounded corners] (0.351,0.923) rectangle (0.525,0.97);
            \draw[red,thick,rounded corners] (0.526,0.923) rectangle (1.0,0.97);
            \draw[black!80,thick, dashed, rounded corners] (0.961,0.92) rectangle (1.0,0.10);
            \draw [-latex, thick, red] (file.base) -- ++(0,-0.05);
            \draw [-latex, thick, red] (zoom.base) -- ++(0,-0.05);
            \draw [-latex, thick, red] (view.base) -- ++(0,-0.05);
            \draw [-latex, thick, red] (app.base) -- ++(0,-0.05);
            \draw [-latex, ultra thick, dashed, black!80] (tools.east) to[out=90, in=-20] (1.0,0.85);
        \end{scope}
    \end{scope}
    \end{tikzpicture}
